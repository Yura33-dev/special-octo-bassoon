...
import UnarchiveOrderForm from '../forms/UnarchiveOrderForm';

interface IDeleteOrderModalProps {
  order: IOrderMapped;
  isSelectedOrderToUnarchive: boolean;
  setIsSelectedOrderToUnarchive: (value: boolean) => void;
}

export default function UnarchiveOrderModal({
  order,
  isSelectedOrderToUnarchive,
