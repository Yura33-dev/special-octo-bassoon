...
export default function EditOrderPageSkeleton() {
  return (
    <Container>
      ...
      <div className='mt-8 grid grid-cols-1 md:grid-cols-2 gap-5'>
        <div className='bg-gray-200 rounded-md p-4 col-span-full'>
          <div className='bg-gray-300 animate-pulse max-w-[230px] h-6'></div>

          <div className='mt-8 flex justify-between items-center gap-2'>
            <div className='bg-gray-300 animate-pulse h-6 rounded-md basis-1/5'></div>
            <div className='bg-gray-300 animate-pulse h-6 rounded-md basis-1/3'></div>
            <div className='bg-gray-300 animate-pulse h-6 rounded-md basis-1/5'></div>
          </div>
        </div>
